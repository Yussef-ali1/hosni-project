  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-teal-50 to-white">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/ourstorypic.jpg')",
      ...
      >
        ...
        <div className="container relative mx-auto px-4 py-16">
          <div className="max-w-5xl mx-auto mb-16 text-center">
            <h1 className="text-5xl font-bold text-white mb-6">Sustainability Gate Story</h1>
            <p className="text-xl text-green-200 max-w-3xl mx-auto">
              Pioneering sustainable solutions for a greener tomorrow
            </p>
          </div>
          
          {/* Videos Section - Using video elements with src */}
          <div className="max-w-5xl mx-auto mb-16 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-4 rounded-lg shadow-lg">
              <div className="aspect-w-16 aspect-h-9 mb-4 rounded overflow-hidden">
                <video 
              ...
              <p className="text-gray-600">Discover our journey and mission to create a sustainable future.</p>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              ...
              <h3 className="text-xl font-bold text-green-700 mb-2">Our Impact</h3>
              <p className="text-gray-600">See how our solutions are making a difference in communities worldwide.</p>
            </div>
          </div>
            ...
            <div className="relative bg-white rounded-xl shadow-xl p-10 border-l-4 border-green-500">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="my-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-green-50 p-6 rounded-lg border-t-4 border-green-500">
                    {/* Added photo for Taher Al-Sheikh */}
                    <div className="mb-4 overflow-hidden rounded-lg h-48">
                      <img 
                        src="/taher.jpg" 
                        alt="Taher Al-Sheikh" 
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-center text-white mb-10">Our Impact</h2>
